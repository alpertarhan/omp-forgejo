...
export function registerForgejoTools(
  ...
  pi.registerTool({
    ...
    label: "Forgejo Tools",
    description:
      "Activate needed Forgejo domains. Load domains ahead of Forgejo operations instead of guessing tool names.",
    parameters: Type.Object({
      domains: Type.Array(Type.Enum(FORGEJO_TOOL_DOMAINS), {
        minItems: 1,
